...
Procedure InitBlendMaps()
  Define.f minHeight0 = 70
  Define.f fadeDist0 = 40
  Define.f minHeight1 = 70
  Define.f fadeDist1 = 15
  Define tx, ty, Size, x, y
  Define.f Height, val
  For ty = #TerrainMiniY To #TerrainMaxiY
    For tx = #TerrainMiniX To #TerrainMaxiX
...
Procedure DoTerrainModify(tx, ty, wx.f, wy.f, wz.f, mBrushSizeTerrainSpace.f, TimeElapsed.f)
  Define.f imgSize = TerrainTileLayerMapSize(0, tx, ty)
  Define.f Pointx = TerrainTilePointX(0, tx, ty, wx, wy, wz)
  Define.f Pointy = TerrainTilePointY(0, tx, ty, wx, wy, wz)
  Define startx, starty, endx, endy
  Define x, y, imgY
  Define.f tsXdist, tsYdist, weight, paint, val
