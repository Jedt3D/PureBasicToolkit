; ------------------------------------------------------------
;
;   PureBasic - NodeAnimation2
;
;    (c) Fantaisie Software
;
; ------------------------------------------------------------
;
; Generated from reference: Multiple animation paths with weight blending
...
Define dx, dy, TimeSinceLastFrame
...
RibbonEffectColor(1, 0, RGBA(0, 255 * 0.8, 255 * 0.8, 255), RGBA(0, 255, 0, 5))
...
Procedure AddPath0(NodeAnimation)
  ...
  CreateNodeAnimationKeyFrame(NodeAnimation, Time * 0.00,  50,  50,   50)
  CreateNodeAnimationKeyFrame(NodeAnimation, Time * 1.25, 950,  50,   50)
  CreateNodeAnimationKeyFrame(NodeAnimation, Time * 2.50, 950,  50, -950)
  CreateNodeAnimationKeyFrame(NodeAnimation, Time * 3.75,  50,  50, -950)
  CreateNodeAnimationKeyFrame(NodeAnimation, Time * 5.00,  50,  50,   50)
...
Procedure AddPath1(NodeAnimation)
  ...
  CreateNodeAnimationKeyFrame(NodeAnimation, Time * 0.0,  50, 280,   50)
  CreateNodeAnimationKeyFrame(NodeAnimation, Time * 1.0,  50,  50, -950)
  CreateNodeAnimationKeyFrame(NodeAnimation, Time * 2.0, 950, 280, -950)
  CreateNodeAnimationKeyFrame(NodeAnimation, Time * 4.0, 950,  50,   50)
  CreateNodeAnimationKeyFrame(NodeAnimation, Time * 4.5, 450,  50, -450)
  CreateNodeAnimationKeyFrame(NodeAnimation, Time * 5.0,  50, 280,   50)
...
Procedure AddPath3(NodeAnimation, Weight.f)
  ...
  CreateNodeAnimationKeyFrame(NodeAnimation, Time * 0.0,  50,  50,   50)
  CreateNodeAnimationKeyFrame(NodeAnimation, Time * 1.0,  50,  50, -950)
  CreateNodeAnimationKeyFrame(NodeAnimation, Time * 2.0, 950, 250, -950)
  CreateNodeAnimationKeyFrame(NodeAnimation, Time * 4.0, 950,  50,   50)
  CreateNodeAnimationKeyFrame(NodeAnimation, Time * 4.5, 450,  50, -450)
  CreateNodeAnimationKeyFrame(NodeAnimation, Time * 5.0,  50,  50,   50)
