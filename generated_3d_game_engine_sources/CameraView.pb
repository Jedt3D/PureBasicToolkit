...
;- Camera
;
CreateCamera(1, 50, 50, 1, 1) ; Added and hidden this camera so camera 0 is not zoomed! Ogre bug?
...
ResizeImage(0, 30 * CameraViewWidth(0) / ImageWidth(0), 30 * CameraViewWidth(0) / ImageWidth(0))
