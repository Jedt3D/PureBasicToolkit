...
Define.i tx_Cubic, tx_rock_diff, tx_rock_normal
...
MoveCamera(0, 0, 2, 0)
CameraLookAt(0, 2, 0, 10)
CreateLight(0, $FFFFFF, 8000, 5700, 4500)
AmbientColor($444444)
...
For i = 0 To 9
  ...
  CreateEntity(i, MeshID(i % 5), MaterialID(i))
  RotateEntity(i, Random(360), Random(360), Random(360), #PB_Absolute)
Next
