...
Define.f KeyX, KeyY, MouseX, MouseY, Angle, Speed, TimeSinceLastFrame
Define.i dx, dy, Quit, i
Global RobotMove.i, FadeIn.i, FadeOut.i, Anim.i
...
Procedure fadeAnimations(deltaTime.f)
  ...
  If FadeOut
    ...
    newWeight = GetEntityAnimationWeight(1, Anim(FadeOut)) - deltaTime * #ANIM_FADE_SPEED
    Clamp(newWeight, 0, 1)
...
Procedure.f CurveAngle(Actuelle.f, Target.f, P.f)
  Protected.f Delta, Valeur
  Delta = WrapPi(Target - Actuelle)
