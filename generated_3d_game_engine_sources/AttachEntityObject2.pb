...
Define.f KeyX, KeyY, MouseX, MouseY, Speed, TimeSinceLastFrame
Define.i RobotMove, Quit, Jet
Define.i dx, dy
...
OpenWindow(0, 0, 0, DesktopUnscaledX(dx), DesktopUnscaledY(dy), "AttachEntityObject2 - [Space] [Return] [Esc] quit", #PB_Window_ScreenCentered)
...
Repeat
  ...
  If RobotMove
    If EntityAnimationStatus(1, "Walk") = #PB_EntityAnimation_Stopped
