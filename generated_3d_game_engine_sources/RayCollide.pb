...
#RayCollidesWith      = #COL_Sphere | #COL_Cylinder ; Ray doesn't collide with Box!
...
Define.f KeyX, KeyY, MouseX, MouseY, RatioX, RatioY, d
Define.f x1, y1, z1, x2, y2, z2
Define.i Shoot, Entity, Event3D, Quit
Define dx, dy
Define Text$
