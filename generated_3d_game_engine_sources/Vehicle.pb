...
; Walls
Define CylinderMesh, Cylinder, i
CreateCube(1, 1)
...
Procedure BuildVehicle(*Vehicle.s_Vehicle)
  Protected.VECTOR3 connectionPointCS0
  ...
  With *Vehicle
    ...
    Protected connectionHeight.f = 0.6

    Protected ChassisMesh = CreateCube(#PB_Any, 2)

    Protected ChassisEntity = CreateEntity(#PB_Any, MeshID(chassisMesh), MaterialID(3), 0, 1, 0)
    ...
    Protected Wheel = CreateSphere(#PB_Any, WheelRadius)
    Protected i
    For i = 0 To 3
