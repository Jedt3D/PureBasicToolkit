...
Define.i dx, dy, i, j, BarrelEntity
Define.f x, y, z
Global.i Quit
...
Dim BarrelOffsets.Vector3(2)
BarrelOffsets(0)\x =  0 : BarrelOffsets(0)\y =  0 : BarrelOffsets(0)\z = 0
BarrelOffsets(1)\x = 60 : BarrelOffsets(1)\y =  0 : BarrelOffsets(1)\z = 0
BarrelOffsets(2)\x = 30 : BarrelOffsets(2)\y = 70 : BarrelOffsets(2)\z = 0
...
For i = 1 To 3
  ...
  Read.f z
  For j=0 To 2
    BarrelEntity = CreateEntity(#PB_Any, MeshID(4), MaterialID(4), x+BarrelOffsets(j)\x, y+BarrelOffsets(j)\y, z+BarrelOffsets(j)\z)
    ScaleEntity(BarrelEntity, 8, 10, 8)
    CreateEntityBody(BarrelEntity, #PB_Entity_CylinderBody, 5, 0, 0.5)
  Next
Next
...
Procedure.i EntityOnGround(entity.i)
...
Procedure main()
  ...
  Protected.f Speed, Speed2, SpeedShoot, x, y, fov, distance
  Protected.f angleX, angleY, vity, vitx, vitz, TimeSinceLastFrame
  Protected.i OnGround, Shoot
  Static.f Jump, Clic
  Static.i MemJump
  Static.Vector3 Rot, Trans
