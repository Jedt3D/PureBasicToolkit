...
; Globals for DISTANCE2 macro
Global DIST_X.f, DIST_Y.f, DIST_Z.f
Macro DISTANCE2(x1, y1, z1, x2, y2, z2, result)
  DIST_X = (x1) - (x2)
  DIST_Y = (y1) - (y2)
  DIST_Z = (z1) - (z2)
  result = DIST_X * DIST_X + DIST_Y * DIST_Y + DIST_Z * DIST_Z
EndMacro
...
; Window gadget IDs
Global Wmain.i
Global Frame_0.i, BT_reset.i, CB_template.i
Global FL_mass.i, label_mass.i, FL_height.i, label_height.i
Global FL_steer.i, label_steer.i, FL_maxspeed.i, label_maxSpeed.i
Global FL_accel.i, label_accel.i, FL_length.i, label_length.i
Global FL_width.i, label_width.i, FL_radius.i, label_radius.i
Global FL_wheelwidth.i, label_wheelWidth.i, FL_wheelMass.i, label_wheelMass.i
Global FL_friction.i, label_friction.i, FL_resti.i, label_resti.i
...
Procedure Wmain_Events(event.i)
  Select event
