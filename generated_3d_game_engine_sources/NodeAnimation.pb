...
; ------------------------------------------------------------
;
; Generated from reference: Camera follows spline path around barrel

EnableExplicit

Declare AddPath(NodeAnimation)

Define.f Duration = 10000, Time
Define NodeAnimation, TimeSinceLastFrame
Define dx, dy
...
CreateNodeAnimationKeyFrame(NodeAnimation, Time * 0,  200,   0,    0)
CreateNodeAnimationKeyFrame(NodeAnimation, Time * 1,    0, -50,  100)
CreateNodeAnimationKeyFrame(NodeAnimation, Time * 2, -500, 100,    0)
CreateNodeAnimationKeyFrame(NodeAnimation, Time * 3,    0, 200, -300)
CreateNodeAnimationKeyFrame(NodeAnimation, Time * 4,  200,   0,    0)
