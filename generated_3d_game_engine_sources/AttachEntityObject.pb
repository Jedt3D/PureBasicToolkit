...
Define.f KeyX, KeyY, MouseX, MouseY, Speed, RollZ, TimeSinceLastFrame
Define.i RobotMove, Quit
Define.i DirtMaterial, RedMaterial, GreenMaterial
Define.i PlaneMesh, RobotMesh, SphereMesh
Define.i Ground, Entity, RedSphere, GreenSphere
Define.i Camera
Define.i dx, dy
...
Entity      = CreateEntity(#PB_Any, MeshID(RobotMesh), #PB_Material_None)
...
Repeat
  ...
  If RobotMove
    If EntityAnimationStatus(Entity, "Walk") = #PB_EntityAnimation_Stopped
      StartEntityAnimation(Entity, "Walk", #PB_EntityAnimation_Manual)
    EndIf
  Else
