...
Define.f a, da, r, MouseX, MouseY, depx, depz, depza, Wireframe
Define.i i, Quit
Define.i dx, dy
...
MoveCamera(0, 30, 20, -20)
CameraLookAt(0, 0, 0, 40)
...
CreateSphere(2, 4, 16, 16)
AddMeshManualLOD(1, 2, 40)
CreateSphere(3, 4, 8, 8)
AddMeshManualLOD(1, 3, 80)
CreateSphere(4, 4, 4, 4)
AddMeshManualLOD(1, 4, 160)
AddMeshManualLOD(1, 4, 0)

CreateSphere(5, 4, 32, 32)
CreateSphere(6, 4, 16, 16)
AddMeshManualLOD(5, 6, 40)
CreateSphere(7, 4, 8, 8)
AddMeshManualLOD(5, 7, 80)
CreateSphere(8, 4, 4, 4)
AddMeshManualLOD(5, 8, 160)
...
Repeat
  ...
  depza + (depz - depza) * 0.05
  MoveCamera(0, depx, 0, -depza)
