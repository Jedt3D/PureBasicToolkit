...
Global CurrentColor.i, CurrentMode.i, StartX.i, StartY.i

Procedure DrawAction(x.i, y.i, EvtType.i)
  Protected rx.i, ry.i
  ...
  If StartDrawing(CanvasOutput(#GADGET_Canvas))
    Select CurrentMode
      ...
      Case #GADGET_Brush
        If EvtType = #PB_EventType_LeftButtonDown Or EvtType = #PB_EventType_MouseMove
      ...
      Case #GADGET_Fill
        If EvtType = #PB_EventType_LeftButtonDown
...
Define Event.i, X.i, Y.i, EvtType.i, File$
Define EventGadgetID.i, Gadget.i
