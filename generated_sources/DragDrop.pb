...
; ------------------------------------------------------------
;
;   PureBasic - Drag & Drop example file
;
...
If OpenWindow(#Window, 0, 0, 760, 310, "Drag & Drop", #PB_Window_SystemMenu | #PB_Window_ScreenCentered)
  ...
  If StartDrawing(ImageOutput(#ImageTarget))
    Box(0, 0, ImageWidth(#ImageTarget), ImageHeight(#ImageTarget), $FFFFFF)
    DrawingMode(#PB_2DDrawing_NativeText)
  ...
  ; Enable dropping on the target gadgets
  ;
  ...
  Repeat
    ...
    ; DragStart event on source gadgets
    ;
