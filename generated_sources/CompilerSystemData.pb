...
; ------------------------------------------------------------
;
;   PureBasic - Compiler, FileSystem and System data
;
...
Debug "MemoryStatus(#PB_System_TotalSwap): " + MemoryStatus(#PB_System_TotalSwap)
Debug "MemoryStatus(#PB_System_FreeSwap): " + MemoryStatus(#PB_System_FreeSwap)
Debug "MemoryStatus(#PB_System_TotalVirtual): " + MemoryStatus(#PB_System_TotalVirtual)
Debug "MemoryStatus(#PB_System_FreeVirtual): " + MemoryStatus(#PB_System_FreeVirtual)
