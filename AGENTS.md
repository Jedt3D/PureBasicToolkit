...
- The extension currently exposes `check`, `compile`, and `run` commands through the repo scripts, plus offline docs, project-aware diagnostics, symbol-aware warnings, workspace symbol search, and lightweight local navigation
