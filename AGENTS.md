...
- The extension currently exposes `check`, `compile`, and `run` commands through the repo scripts, plus offline docs, lightweight diagnostics, and lightweight local navigation
